...
export const Register = () => {
    ...
    const inputStyle = "w-full bg-white text-black text-xl font-bold px-4 py-3 rounded border-4 border-[#888] focus:border-[#0088dd] focus:outline-none focus:shadow-[0_0_15px_#0088dd] placeholder-gray-400 transition-all shadow-inner uppercase font-mono tracking-wider";
